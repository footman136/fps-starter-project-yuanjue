        ...
        private bool SendPositionUpdate()
        {
                ...
                out var messageStamp))
            {
                ...
                if (anyMovement || !lastMovementStationary)
                {
                    ...
                    //Debug.Log("SendPositionUpdate:"+ messageStamp +
                    //    " x:"+ clientRequest.Movement.X + " y:"+clientRequest.Movement.Y+" z:"+ clientRequest.Movement.Z +
                    //    " jump:"+ clientRequest.IncludesJump
                    //    );
        ...
        private bool SendRotationUpdate()
        {
            ...
            if (cumulativeRotationTimeDelta > rotationUpdateDelta)
            {
                if (pitchDirty || rollDirty || yawDirty)
                {
                    ...
                    //Debug.Log("SendRotationUpdate:" + cumulativeRotationTimeDelta +
                    //    " Pitch:" + rotationUpdate.Pitch + " Roll:" + rotationUpdate.Roll + " Yaw:" + rotationUpdate.Yaw
                    //);
